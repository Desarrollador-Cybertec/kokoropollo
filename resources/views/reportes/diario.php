    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="flex gap-3 justify-center flex-wrap">
            ...
            <a href="/reportes/diario?fecha=<?= View::escape($fecha) ?>&export=csv"
                class="font-bold px-5 py-3 rounded-xl btn-secondary">📥 CSV</a>
            <a href="/reportes/diario?fecha=<?= View::escape($fecha) ?>&export=xls"
                class="font-bold px-5 py-3 rounded-xl btn-secondary">📊 Excel</a>
