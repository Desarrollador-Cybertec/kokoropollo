...
<head>
    ...
    <title>Panel Administración — Kokoro Pollo</title>
...
<body class="min-h-screen flex flex-col" style="background: linear-gradient(135deg,#3b0a0a 0%,#4a0e0e 40%,#2b1a1a 100%)">
    ...
    <main class="flex-1 flex flex-col items-center justify-center p-6 gap-8">
        <p class="text-oro text-2xl md:text-3xl font-bold tracking-widest uppercase">Panel de Administración</p>

        <div class="bg-rojo-600/80 rounded-2xl shadow-2xl p-8 w-full max-w-2xl">
